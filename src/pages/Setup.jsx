  ...
  return (
    <div className="bg-[#f5f6f7] min-h-screen pt-32 pb-20 px-4 sm:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-black text-[#111111] tracking-tight mb-6">Setup Guide</h1>
          <p className="text-xl text-black/60 leading-relaxed max-w-3xl">
            This is the placeholder page for Setup Guide. Content will be added here shortly.
          </p>
        </motion.div>
      </div>
    </div>
